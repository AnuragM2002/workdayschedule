...
$(function () {
  ...
  // 
    ...
    $('.saveBtn').on('click', function () {
      ...
      localStorage.setItem(timeOfDay, val)
  ...
  $('#hour-19 .description').val(localStorage.getItem('hour-17'));
  $('#hour-20 .description').val(localStorage.getItem('hour-17'));
  $('#hour-21 .description').val(localStorage.getItem('hour-17'));
